...
from constants import (
    ...
    KEY_VERSION, KEY_HALTED, KEY_WIN_START, KEY_WIN_SPEND,
...
def do_pay():
    ...
    return Seq([
        ...
        # Treasury is always permitted — it IS the x402 toll target.
        # Any other recipient must have a box entry created by the master wallet.
        If(
            recipient != treasury,
            Assert(
                App.box_length(recipient).hasValue(),
                comment="RECIPIENT_NOT_WHITELISTED",
            ),
        ),
